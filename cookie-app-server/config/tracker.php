...
return [
    ...
    'allowed_origins' => explode(',', env('TRACKER_ALLOWED_ORIGINS', 'http://localhost:8002,http://localhost:8003')),

    // Domain used for tracker cookie. Use your tracker domain or parent domain.
    'cookie_domain' => env('TRACKER_COOKIE_DOMAIN', 'http://localhost:8001'),
